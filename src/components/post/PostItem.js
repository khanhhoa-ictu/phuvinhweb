...
function PostItem({ image, date, title, summary, id }) {
  return (
    <div className="relative post-container rounded-lg min-w-[250px] lg:min-w-[300px] xl:min-w-[370px] lg:max-w-[373px] w-full md:max-h-[400px] lg:max-h-[800px]">
      <div
        className={`post-card w-full border border-[#0018421a] bg-white rounded-lg flex flex-col sm:flex-row lg:flex-col gap-6 lg:max-w-[373px] lg:pb-8 md:max-h-[400px] lg:max-h-[800px]`}
      >
        ...
        <div className="flex-1 sm:h-full lg:h-[55%] flex flex-col px-3 lg:px-4 justify-between sm:w-[60%] lg:w-full sm:gap-[10px] flex-shrink-0 mb-4 sm:mt-4 lg:m-0">
          <div className="flex flex-col text-[#333]">
            <p className="mb-[10px] sm:mb-[5px] lg:mb-[10px]">
