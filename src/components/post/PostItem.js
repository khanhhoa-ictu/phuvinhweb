...
function PostItem({ image, date, title, summary, index = "" }) {
  return (
    <div className="relative post-container" >
      <div
        className={`post-card w-full border border-[#261797] bg-white rounded-lg flex flex-col sm:flex-row lg:flex-col gap-6 lg:max-w-[373px] lg:pb-8`}
      >
        <div className="rounded-t-lg sm:rounded-t-lg lg:rounded-t-lg sm:w-[40%] lg:w-full">
          <Image
            ...
            height={240}
            alt="image blog"
            className="w-full rounded-t-lg sm:rounded-l-lg sm:rounded-t-lg lg:rounded-t-lg h-[240px] object-cover"
          />
        </div>
        <div className="flex-1 sm:h-full lg:h-[55%] flex flex-col px-3 lg:px-4 justify-between sm:w-[60%] lg:w-full sm:gap-[10px] flex-shrink-0">
